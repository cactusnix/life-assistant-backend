...
type Order struct {
	...
	Amount      string    `gorm:"not null;comment:'基金购入份额'" form:"amount" json:"amount"`
	UnitCost    string    `gorm:"not null;comment:'基金购入成本单价'" form:"unitCost" json:"unitCost" binding:"required"`
	CostPrice   string    `gorm:"not null;comment:'基金购入成本'" form:"costPrice" json:"costPrice" binding:"required"`
